...
import com.example.teste.security.SecurityFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(req -> {
                    ...
                    // Rotas de cursos
                    req.requestMatchers(HttpMethod.GET, "/produtos", "/produtos/*", "/baixo-estoque", "/movimentacoes", "/movimentacoes/produto/*").hasAnyRole("USER", "ADMIN");
                    req.requestMatchers(HttpMethod.POST, "/movimentacoes", "/produtos").hasAnyRole("ADMIN", "USER");
                    req.requestMatchers(HttpMethod.PUT, "/produtos", "/movimentacoes").hasAnyRole("USER", "ADMIN");
                    req.requestMatchers(HttpMethod.DELETE, "/produtos/*").hasRole(Role.ADMIN.name());
