...
import static com.example.teste.usuario.Role.OPERADOR;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(req -> {
                    ...
                    // Rotas de produtos
                    req.requestMatchers(HttpMethod.GET, "/produtos", "/produtos/*" , "/movimentacoes", "/movimentacoes/*").hasAnyRole("OPERADOR", "ADMIN");
                    ...
                    req.requestMatchers(HttpMethod.DELETE, "/produtos/*" , "/movimentacoes/*").hasRole(Role.ADMIN.name());
