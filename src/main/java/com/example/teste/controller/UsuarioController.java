...
import com.example.teste.dto.RedefinirSenhaDTO;
import com.example.teste.service.UsuarioService;
import com.example.teste.usuario.DadosDetalhamentoUsuario;
...
public class UsuarioController {
    ...
    @GetMapping("/{id}")
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<com.example.teste.usuario.DadosDetalhamentoUsuario> buscarUsuario(@PathVariable Long id) {
